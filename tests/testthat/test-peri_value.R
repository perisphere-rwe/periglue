...
test_that("rounding specifications match intent", {
  ...
  expect_equal(peri_value(x, rspec_sig_1_even),
               c("1", "10", "100", "1,000"))

  expect_equal(peri_value(y, rspec_sig_1_even),
               c('-1', '-2', '-4', '-4'))

  expect_equal(peri_value(x, rspec_mag_even),
               c("1.23", "12.3", "123", "1,234"))

  expect_equal(peri_value(x, rspec_dig_1_even),
               c("1.2", "12.3", "123.4", "1,234.5"))

  #peri_value(y, rspec_dig_1_even)
  ...
  expect_equal(peri_value(x, rspec_sig_1_up),
               c("1", "10", "100", "1,000"))

  expect_equal(peri_value(x, rspec_mag_up),
               c("1.23", "12.3", "123", "1,235"))

  expect_equal(peri_value(x, rspec_dig_1_up),
...
test_that("rounding on boundaries matches specification", {
  ...
  expect_equal(peri_value(x, rspec_mag_up), c('1.0', '10'))
